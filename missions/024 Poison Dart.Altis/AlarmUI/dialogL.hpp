...
{
	idc = 1000;
	text = "00:00:00  Successful detonation  127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
...
{
	idc = 1000;
	text = "00:00:00  Trigger group faulted  127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
...
{
	idc = 1001;
	text = "03:37:16  Device loaded 127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
...
{
	idc = 1001;
	text = "03:37:11  Tonga Systems POST  127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
...
{
	idc = 1002;
	text = "02:36:57  Lt. Amani checked into Tonga 127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
...
{
	idc = 1002;
	text = "01:35:02  Sentry shift swap  127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
...
{
	idc = 1003;
	text = "00:44:33  Automatic System update ready for install 127.0.0.1"; //--- ToDo: Localize;
	x = 0.396875 * safezoneW + safezoneX;
