GroupOne_X = [getMarkerPos "land2O_1_1_3", WEST, ["B_SDV_01_F"]] call BIS_fnc_spawnGroup;
...
_waypoint2 = GroupOne_X addwaypoint[getmarkerpos"point_4_1",0];
_waypoint2 setwaypointtype"GETOUT";

_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"point_4_2",0];
...
GroupOne_X = [getMarkerPos "land2O_1_1", WEST, ["B_Boat_Armed_01_minigun_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
