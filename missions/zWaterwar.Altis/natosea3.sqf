GroupOne_X = [getMarkerPos "land2O_1_1_1", WEST, ["B_SDV_01_F"]] call BIS_fnc_spawnGroup;
...
GroupOne_X = [getMarkerPos "land2O_1_1_1_1", WEST, ["B_Boat_Armed_01_minigun_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;

_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"point_11",0];
_waypoint0 setwaypointtype"SAD";

_waypoint1 = GroupOne_X addwaypoint[getmarkerpos"point_9",0];
_waypoint1 setwaypointtype"SAD";
