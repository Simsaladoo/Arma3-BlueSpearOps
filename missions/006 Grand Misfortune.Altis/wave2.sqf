GroupOne_X = [getMarkerPos "asd1_10", EAST, ["O_Soldier_F", "O_Soldier_AR_F","O_Soldier_F"]] call BIS_fnc_spawnGroup;
...
GroupOne_X = [getMarkerPos "asd1_9", EAST, ["O_Soldier_F", "O_Soldier_AR_F", "O_Soldier_GL_F","O_Soldier_F","O_Soldier_F","O_Soldier_GL_F",]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
