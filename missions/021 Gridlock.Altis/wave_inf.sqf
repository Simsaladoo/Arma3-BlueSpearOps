...
GroupOne_X = [getMarkerPos "point_4_2_2", EAST, ["O_Soldier_TL_F", "O_Soldier_F", "O_Soldier_GL_F","O_Soldier_AR_F","O_Soldier_F","O_Soldier_GL_F"]] call BIS_fnc_spawnGroup;
...
_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"spawn3_2_3_2",0];
_waypoint0 setwaypointtype"Move";

_waypoint1 = GroupOne_X addwaypoint[getmarkerpos"spawn3_2_3",0];
_waypoint1 setwaypointtype"Move";

_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"spawn3_2_2",0];
_waypoint0 setwaypointtype"Move";
...
GroupOne_X = [getMarkerPos "point_4_2_3_1", EAST, ["O_Soldier_TL_F", "O_Soldier_F", "O_Soldier_GL_F","O_Soldier_AR_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
GroupOne_X setSkill ["aimingspeed", 0.15];
GroupOne_X setSkill ["spotdistance", 0.15];
GroupOne_X setSkill ["aimingaccuracy", 0.1];
...
GroupOne_X = [getMarkerPos "point_4_2_2_2", EAST, ["O_G_Offroad_01_armed_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
