...
_waypoint0 = GroupOne_X addwaypoint[getPos asdasd,0];
_waypoint0 setwaypointtype"Move";
_waypoint0 setwaypointhouseposition 43;

_waypoint1 = GroupOne_X addwaypoint[getPos asdasd,0];
_waypoint1 setwaypointtype"Move";
_waypoint1 setwaypointhouseposition 43;
