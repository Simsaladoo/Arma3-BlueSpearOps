/*
	...
	groupSize 	= 	1-8 (infantry groups' size) 																						DEFAULT: 16
	...
	smoke		=	[LZ smoke, cover smokes, flare, chemlights] (if chopper uses these on landing spot)									DEFAULT: [false,true,false,false]
	...
	custom init = 	"init commands" (if you want something in init field of units, put it here) 										DEFAULT: "removeheadgear this;"
...
_BLUchoppers = ["A3_Air_F_Beta_Heli_Attack_01","A3_Air_F_Beta_Heli_Attack_01","A3_Air_F_Beta_Heli_Attack_01"];
