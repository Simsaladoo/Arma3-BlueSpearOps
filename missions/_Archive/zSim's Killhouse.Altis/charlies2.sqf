...
_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"ammo_4",0];
_waypoint0 setwaypointtype"Move";
_waypoint0 setwaypointhouseposition 12;

_waypoint1 = GroupOne_X addwaypoint[getmarkerpos"ammo",0];
_waypoint1 setwaypointtype"SAD";
_waypoint1 setwaypointhouseposition 12;

_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"ammo_7",0];
