...
GroupOne_X = [getMarkerPos "lak_2", EAST, ["O_MBT_02_cannon_F"]] call BIS_fnc_spawnGroup;
...
GroupOne_X = [getMarkerPos "lak", EAST, ["O_G_Offroad_01_armed_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
...
_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"jet2",0];
_waypoint0 setwaypointtype"Move";
...
GroupOne_X = [getMarkerPos "lak_1", EAST, ["O_APC_Wheeled_02_rcws_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;

_waypoint0 = GroupOne_X addwaypoint[getmarkerpos"stav2",0];
_waypoint0 setwaypointtype"Move";

_waypoint1 = GroupOne_X addwaypoint[getmarkerpos"three",0];
_waypoint1 setwaypointtype"Move";
