GroupOne_X = [getMarkerPos "land1O_1_1", EAST, ["B_SDV_01_F"]] call BIS_fnc_spawnGroup;
...
GroupOne_X = [getMarkerPos "land1O_1_1_2", EAST, ["O_Boat_Armed_01_hmg_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
