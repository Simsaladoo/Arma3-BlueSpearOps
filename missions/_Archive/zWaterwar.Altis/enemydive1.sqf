...
GroupOne_X = [getMarkerPos "land10_1", EAST, ["O_diver_TL_F", "O_diver_exp_F", "O_diver_exp_F", "O_diver_F"]] call BIS_fnc_spawnGroup;
...
GroupOne_X = [getMarkerPos "land10_1_3", EAST, ["O_diver_TL_F", "O_diver_exp_F", "O_diver_exp_F", "O_diver_F"]] call BIS_fnc_spawnGroup;
{_x allowFleeing 0} forEach units GroupOne_X;
