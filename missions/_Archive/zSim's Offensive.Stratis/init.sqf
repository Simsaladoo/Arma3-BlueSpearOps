...
#define WELCOME_MESSAGE	"Simsaladoo's Offensive of Stratis Island\n" +\
						""
...
/*[] spawn {
	...
	[[6400,6400,6400],"We have cleared the Air Station and received reinforcements.|Listen to HQ and neutralise all enemies designated. Good Hunting. Out."] spawn BIS_fnc_establishingShot;
...
<t size='1.2' align='center'>You've successfully completed Simsaladoo's Invasion!</t><br/>
____________________<br/>
<br/>
What??? You couldn't have actually won the mission.  Better turn on Perpetual Mode to make the game play infinitely.<br/>
<br/>
